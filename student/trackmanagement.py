...
class Track:
    ...
    def __init__(self, meas, id):
        ...
        pos = np.ones((4,1))
        pos[0:3] = meas.z[0:3]
        pos_veh = meas.sensor.sens_to_veh*pos        
        ...
        s44 = params.sigma_p44
        s55 = params.sigma_p55 
        s66 = params.sigma_p66
        
        P_vel = np.matrix([[s44**2, 0, 0],
                        [0, s55**2, 0],
                        [0, 0, s66**2]])
...
class Trackmanagement:
    ...
    def manage_tracks(self, unassigned_tracks, unassigned_meas, meas_list):  
        ...
        for track in self.track_list:
           ...
           if ((track.state == 'initialized' or track.state == 'tentative') and (track.P[0,0] > params.max_P or track.P[1,1] > params.max_P or track.score < 1 / params.window)):
                self.delete_track(track)
